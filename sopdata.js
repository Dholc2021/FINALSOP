...
const sopData = {
  ...
  "pricing_policy": {
    "title": "Pricing Policy Standard Operating Procedure (SOP)",
    "steps": [
      {
        "step": "Step 1: Understanding Our Rates",
        "actions": [
      ...
      {
        "step": "Step 2: Available Discounts",
        "actions": [
